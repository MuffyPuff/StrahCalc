...
#ifndef EXPRTK_GMP_ADAPTOR_HPP
#define EXPRTK_GMP_ADAPTOR_HPP
...
inline bool string_to_real(Iterator &itr_external, const Iterator end,
                           mpq_class &t, numeric::details::mpq_type_tag);
...
namespace details
{
inline void print_type(const std::string &, const mpq_class &v,
...
template<> struct number_type<mpq_class> {
	typedef mpq_type_tag type;
};
...
template <typename T> inline T   abs_impl(const T &v, mpq_type_tag)
{
	return abs(v);
}
template <typename T> inline T  acos_impl(const T &v, mpq_type_tag)
{
	return acos(v);
}
template <typename T> inline T acosh_impl(const T &v, mpq_type_tag)
{
	return acosh(v);
}
template <typename T> inline T  asin_impl(const T &v, mpq_type_tag)
{
	return asin(v);
}
template <typename T> inline T asinh_impl(const T &v, mpq_type_tag)
{
	return asinh(v);
}
template <typename T> inline T  atan_impl(const T &v, mpq_type_tag)
{
	return atan(v);
}
template <typename T> inline T atanh_impl(const T &v, mpq_type_tag)
{
	return atanh(v);
}
template <typename T> inline T  ceil_impl(const T &v, mpq_type_tag)
{
	return ceil(v);
}
template <typename T> inline T   cos_impl(const T &v, mpq_type_tag)
{
	return cos(v);
}
template <typename T> inline T  cosh_impl(const T &v, mpq_type_tag)
{
	return cosh(v);
}
template <typename T> inline T   exp_impl(const T &v, mpq_type_tag)
{
	return exp(v);
}
template <typename T> inline T floor_impl(const T &v, mpq_type_tag)
{
	return floor(v);
}
template <typename T> inline T   log_impl(const T &v, mpq_type_tag)
{
	return log(v);
}
template <typename T> inline T log10_impl(const T &v, mpq_type_tag)
{
	return log10(v);
}
template <typename T> inline T  log2_impl(const T &v, mpq_type_tag)
{
	return log2(v);
}
template <typename T> inline T   neg_impl(const T &v, mpq_type_tag)
{
	return -v;
}
template <typename T> inline T   pos_impl(const T &v, mpq_type_tag)
{
	return  v;
}
template <typename T> inline T   sin_impl(const T &v, mpq_type_tag)
{
	return sin(v);
}
template <typename T> inline T  sinh_impl(const T &v, mpq_type_tag)
{
	return sinh(v);
}
template <typename T> inline T  sqrt_impl(const T &v, mpq_type_tag)
{
	return sqrt(v);
}
template <typename T> inline T   tan_impl(const T &v, mpq_type_tag)
{
	return tan(v);
}
template <typename T> inline T  tanh_impl(const T &v, mpq_type_tag)
{
	return tanh(v);
}
template <typename T> inline T   cot_impl(const T &v, mpq_type_tag)
{
	return cot(v);
}
template <typename T> inline T   sec_impl(const T &v, mpq_type_tag)
{
	return sec(v);
}
template <typename T> inline T   csc_impl(const T &v, mpq_type_tag)
{
	return csc(v);
}
template <typename T> inline T   r2d_impl(const T &v, mpq_type_tag)
{
	return (v  * exprtk::details::constant::_180_pi);
}
template <typename T> inline T   d2r_impl(const T &v, mpq_type_tag)
{
	return (v  * exprtk::details::constant::pi_180);
}
template <typename T> inline T   d2g_impl(const T &v, mpq_type_tag)
{
	return (v  * mpq_class(20.0 / 9.0));
}
template <typename T> inline T   g2d_impl(const T &v, mpq_type_tag)
{
	return (v  * mpq_class(9.0 / 20.0));
}
template <typename T> inline T  notl_impl(const T &v, mpq_type_tag)
{
	return (v != mpq_class(0) ? mpq_class(0) : mpq_class(1));
}
template <typename T> inline T  frac_impl(const T &v, mpq_type_tag)
{
	return (v);
}
template <typename T> inline T trunc_impl(const T &v, mpq_type_tag)
{
	return (v);
}
